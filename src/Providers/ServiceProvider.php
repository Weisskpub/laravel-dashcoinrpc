...
namespace Weisskpub\Dashcoin\Providers;

use Weisskpub\Dashcoin\Client as DashcoinClient;
...
class ServiceProvider extends IlluminateServiceProvider
{
    ...
    {
        $aliases = [
            'dashcoind' => 'Weisskrub\Dashcoin\Client',
        ];
    ...
    protected function registerClient()
    {
        $this->app->singleton('dashcoind', function ($app) {
            return new DashcoinClient([
                ...
                'port'   => $app['config']->get('dashcoind.port', 9998),
